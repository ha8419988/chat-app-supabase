...
import 'package:chat_app_supabase/data/table/user/chat/user_chat_table.dart';
import 'package:chat_app_supabase/data/table/user/user_table.dart';
...
import '../../data/table/user/chat/message_table.dart';
...
class ChatRepository with IChatRepository {
  ...
  Future<bool> send(String roomId, String receiverId, String message,
    ...
    try {
      ...
      await _supabase.client.from(chatTable.tableName).update({
        chatTable.lastMessage: message,
        chatTable.timeSend: '${DateTime.now()}'
