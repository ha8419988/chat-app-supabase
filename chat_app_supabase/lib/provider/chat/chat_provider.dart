import 'dart:async';
import 'package:chat_app_supabase/data/models/chat/message/message_data.dart';
...
import '../auth/chat_repository.dart';
...
class ChatProvider extends ChangeNotifier {
  ...
  void send(String roomId, String receiverId,
      {String type = 'message',
      required Function() success,
    ...
    final result =
        await _repo.send(roomId, receiverId, '$_message', type: type);
