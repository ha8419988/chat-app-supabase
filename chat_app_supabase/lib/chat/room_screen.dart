...
import 'package:chat_app_supabase/provider/chat/chat_provider.dart';
import 'package:chat_app_supabase/widget/chat_receiver_card.dart';
import 'package:chat_app_supabase/widget/sliver_sized_box.dart';
              ...
              return Container(
                ...
                child: TextFormField(
                  ...
                  onFieldSubmitted: (it) {
                    ...
                    ///send message
                    chatProvider.send('${widget.roomData.roomId}',
                        '${widget.roomData.senderId}', success: () {
                      ///enable message input box
                      chatProvider.enableMessageBoxChange(true);
                    }, failure: () {
                      ///show snackbar
                      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                          content: Text('Send Message Failure!')));
